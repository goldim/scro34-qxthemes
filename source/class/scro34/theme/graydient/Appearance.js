...
/**
 * The Graydient appearance theme.
 *
 * @asset(scro34/graydient/*)
 * 
...
qx.Theme.define("scro34.theme.graydient.Appearance",
{
  aliases: {
    decoration: "scro34/graydient/decoration"
  },
  ...
  appearances:
  {
    ...
    */
    ...
    "combobox/button":
    {
      ...
      style: function(states)
      {
        ...
        return {
          icon: scro34.theme.graydient.Image.URLS["arrow-down"],
          cursor: states.disabled ? "default" : "pointer",
          decorator: decorator,
          margin: 0,
    ...
    */
    ...
    "datechooser/button":
    {
      ...
      style: function(states)
      {
        ...
        if (states.lastYear) {
          result.icon = scro34.theme.graydient.Image.URLS["arrow-rewind"];
          result.paddingLeft = 5;
          result.paddingRight = 1;
        } else if (states.lastMonth) {
          result.icon = scro34.theme.graydient.Image.URLS["arrow-left"];
        } else if (states.nextYear) {
          result.icon = scro34.theme.graydient.Image.URLS["arrow-forward"];
          result.paddingLeft = 5;
          result.paddingRight = 1;
        } else if (states.nextMonth) {
          result.icon = scro34.theme.graydient.Image.URLS["arrow-right"];
        }
    ...
    */
    ...
    "datefield/button":
    {
      ...
      {
        return {
          icon: "scro34/graydient/icon/16/office-calendar.png",
          padding: [0, 2]
        };
      }
    },
    ...
    */
    ...
    "menu-slidebar/button-backward":
    {
      ...
      {
        return {
          icon: scro34.theme.graydient.Image.URLS[
    ...
    "menu-button/arrow":
    {
      ...
      {
        return {
          source: scro34.theme.graydient.Image.URLS[
      ...
      style: function(states)
      {
        return {
          icon: !states.checked ? undefined :
            scro34.theme.graydient.Image.URLS[
    ...
    */
    ...
    "scrollbar/button":
    {
      style: function(states)
      {
        ...
        styles.icon = scro34.theme.graydient.Image.URLS["arrow-" + icon + "-small"];
    ...
    */
    ...
    "selectbox/arrow":
    {
      ...
      {
        return {
          source: scro34.theme.graydient.Image.URLS["arrow-down"],
          paddingRight: 4,
          paddingLeft: 5
        };
      }
    ...
    */
    ...
    "slidebar/button-forward":
    {
      ...
      {
        return {
          icon: scro34.theme.graydient.Image.URLS["arrow-" + (states.vertical ? "down" : "right")],
          padding: 5
        };
      }
    },
    ...
    "slidebar/button-backward":
    {
      ...
      {
        return {
          icon: scro34.theme.graydient.Image.URLS["arrow-" + (states.vertical ? "up" : "left")],
          padding: 5
        };
      }
    },
    ...
    */
    ...
    "spinner/upbutton":
    {
      ...
      {
        return {
          icon: scro34.theme.graydient.Image.URLS["arrow-up-small"],
    ...
    "spinner/downbutton":
    {
      ...
      {
        return {
          icon: scro34.theme.graydient.Image.URLS["arrow-down-small"],
          padding: states.pressed ? [1, 4, 0, 4] : [0, 4, 1, 4]
        };
      }
    },
    ...
    "splitpane/splitter/knob":
    {
      style: function(states)
      {
        return {
          ...
          source: states.horizontal ? scro34.theme.graydient.Image.URLS["knob-horizontal"] : 
                                      scro34.theme.graydient.Image.URLS["knob-vertical"]
        };
      }
    },
    ...
    "table/column-button":
    {
      ...
      style: function(states)
      {
        return {
          ...
          icon: scro34.theme.graydient.Image.URLS["select-column-order"]
        };
      }
    },
      ...
      style: function(states)
      {
        return {
          ...
          sortIcon: states.sorted ?
              (scro34.theme.graydient.Image.URLS["table-" +
    ...
    */
    ...
    "tabview-page/button/close-button":
    {
      ...
      style: function(states)
      {
        return {
          cursor: states.disabled ? undefined : "pointer",
          icon: states.hovered ? scro34.theme.graydient.Image.URLS["tabview-close-hovered"] :
                                  scro34.theme.graydient.Image.URLS["tabview-close"]
        };
      }
    },
