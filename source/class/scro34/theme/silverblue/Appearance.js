...
/**
 * The SilverBlue appearance theme.
 *
 * @asset(scro34/silverblue/*)
 * 
...
qx.Theme.define("scro34.theme.silverblue.Appearance",
{
  aliases: {
    decoration: "scro34/silverblue/decoration"
  },
  ...
  appearances:
  {
    ...
    */
    ...
    "datefield/button":
    {
      ...
      {
        return {
          icon: "scro34/silverblue/icon/16/office-calendar.png",
          padding: [3, 4, 4, 4]
        };
      }
    },
